...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2025 at 07:17 AM
...
--
-- Table structure for table `loan_consent`
--

CREATE TABLE `loan_consent` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `consent_status` enum('yes','no') NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `loan_consent`
--

INSERT INTO `loan_consent` (`id`, `user_id`, `consent_status`, `created_at`, `updated_at`) VALUES
(1, 2147483647, 'yes', '2025-04-22 04:30:39', '2025-04-22 04:30:39');
...
(1, '1234567890123', 'เกี่ยวกับ การบริจาคร่างกาย', 'าา', 'หหห', '../uploads/ER DIAGRAM_page-0001.jpg', 9, '2022-11-02 00:00:00', '2025-05-03 00:00:00', '2025-03-19 04:59:33', 1),
...
(21, '1234567890123', 'เกี่ยวกับ สถาปนิก 67', 'บ้านแม่', 'ช่วยทำงาน', '../uploads/thumb-1920-1372106.jpeg', 0, '2025-04-28 00:00:00', '2025-05-12 00:00:00', '2025-04-28 02:48:54', 20);
...
('1234567890123', '1234567890', '$2y$10$ebtJzf5ejmGJQwThvYklauA0cH3sp6pRnsGmcSF4DJL8EsXmgn1bW', 'GGG', 'HHH', '1231231/1231321', '1234567890', '-', 'test@gmail.com', '/xampp/htdocs/Project_Final/uploads/licensed-image.jpg', '2', '1', '3', 'G345', '2', 1, '1', 'สมรส'),
...
--
-- Indexes for table `loan_consent`
--
ALTER TABLE `loan_consent`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `loan_consent`
--
ALTER TABLE `loan_consent`
