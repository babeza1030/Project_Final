...
// ดึงข้อมูลจากตาราง family_status_code เฉพาะตัวเลือก 3.1 ถึง 3.4
$sql = "SELECT status_code_id, description FROM family_status_code WHERE status_code_id IN ('3.1', '3.2', '3.3', '3.4')";
...
​3. ไม่ได้ประกอบอาชีพ คือ ไม่มีรายได้ ไม่ได้ทำงานใด ๆ เช่น พ่อบ้าน แม่บ้าน พิการ ป่วย บวช มีโทษจำคุก ฯลฯ</p>
        ...
        <form action="user_page2_form3_3.php" method="post">
