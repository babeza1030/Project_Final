...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2025 at 05:33 AM
...
INSERT INTO `student` (`student_id`, `student_code`, `password`, `f_name`, `l_name`, `address`, `phone_number`, `phone_number_home`, `email`, `profile_image`, `spouse_id`, `father_id`, `mother_id`, `guardian_id`, `endorser_id`, `department_id`, `s_faculty`, `s_department`, `family_status_id`, `family_status`) VALUES
